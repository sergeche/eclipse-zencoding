...
# Add "http://zen-coding.ru/eclipse/updates/":http://zen-coding.ru/eclipse/updates/ in update sites
...
*WARNING: this plugin doesn't work Aptana 2 Standalone. Please "download Eclipse IDE":http://eclipse.org/ and install Aptana as a plugin in it*